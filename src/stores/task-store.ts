...
export interface Task {
  ...
  comments?: { id: string; content: string; isEdited?: boolean; createdAt: string; user: { id: string; name: string | null; image: string | null } }[];
  blockedBy?: { id: string; blockingId: string; blockedId: string; blocking: { id: string; title: string } }[];
  blocks?: { id: string; blockingId: string; blockedId: string; blocked: { id: string; title: string } }[];
